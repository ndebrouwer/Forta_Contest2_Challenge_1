...
import { BlockEvent, TransactionEvent } from "../../sdk";
...
export declare type CreateTransactionEvent = (receipt: JsonRpcTransactionReceipt, block: JsonRpcBlock, networkId: number, traces: Trace[]) => TransactionEvent;
