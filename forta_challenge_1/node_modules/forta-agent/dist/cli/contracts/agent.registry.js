...
var AgentRegistry = (function () {
    ...
    AgentRegistry.prototype.agentExists = function (agentId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.getContract().getAgent(agentId)];
                    case 1:
                        agent = _a.sent();
                        return [2, !!agent.metadata];
                }
            });
        });
    };
    AgentRegistry.prototype.createAgent = function (fromWallet, agentId, reference) {
        return __awaiter(this, void 0, void 0, function () {
            var from, contract, gas, txOptions, tx;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        from = fromWallet.getAddress();
                        contract = this.getContract(fromWallet);
                        return [4, contract.estimateGas.createAgent(agentId, from, reference, [1])];
                    case 1:
                        gas = _a.sent();
                        return [4, this.getTxOptions(gas, fromWallet)];
                    case 2:
                        txOptions = _a.sent();
                        return [4, contract.createAgent(agentId, from, reference, [1], txOptions)];
                    case 3:
                        tx = _a.sent();
                        return [4, tx.wait()];
                    case 4:
    ...
    AgentRegistry.prototype.updateAgent = function (fromWallet, agentId, reference) {
        return __awaiter(this, void 0, void 0, function () {
            var contract, gas, txOptions, tx;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        contract = this.getContract(fromWallet);
                        return [4, contract.estimateGas.updateAgent(agentId, reference, [1])];
                    case 1:
                        gas = _a.sent();
                        return [4, this.getTxOptions(gas, fromWallet)];
                    case 2:
                        txOptions = _a.sent();
                        return [4, contract.updateAgent(agentId, reference, [1], txOptions)];
                    case 3:
                        tx = _a.sent();
                        return [4, tx.wait()];
                    case 4:
