...
exports.keccak256 = exports.assertIsFromEnum = exports.assertIsNonEmptyString = exports.createBlockEvent = exports.createTransactionEvent = exports.getJsonRpcUrl = exports.getFortaConfig = void 0;
...
var getJsonRpcUrl = function () {
    ...
    var jsonRpcUrl = exports.getFortaConfig().jsonRpcUrl;
    if (!jsonRpcUrl)
        throw new Error('no jspnRpcUrl found');
